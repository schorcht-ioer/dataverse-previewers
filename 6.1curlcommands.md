...
This previewer reads GeoTIFF and "standard" TIFF files. It is recommended to save GeoTIFFs as COG (cloud-optimized GeoTIFF). This automatically adds overlays (pyramid layers) to GeoTIFFs and splits them into tiles, ensuring they are displayed efficiently. GeoTIFFs without overlays are only loaded if they are 50 MB or smaller. The file size limit can be adjusted as needed in previewers/v1.5/js/mapraster.js, although this adjusted version must then also be hosted by yourself (e.g. via github pages). Instructions on how to build external tools yourself can be found here: https://guides.dataverse.org/en/latest/api/external-tools.html.  
...
'{
  ...
  "scope":"file",
  "types":["preview"],
  "toolUrl":"https://gdcc.github.io/dataverse-previewers/previewers/v1.5/RichHtmlPreview.html",
  "toolParameters": {
      "queryParameters":[
        {"fileid":"{fileId}"},
        {"siteUrl":"{siteUrl}"},
...
'{
  ...
  "scope":"file",
  "types":["preview"],
  "toolUrl":"https://gdcc.github.io/dataverse-previewers/previewers/v1.5/ROCrate.html",
  "toolParameters": {
      "queryParameters":[
        {"fileid":"{fileId}"},
        {"siteUrl":"{siteUrl}"},
