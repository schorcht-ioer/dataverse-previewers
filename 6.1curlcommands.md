...
'{
  ...
  "allowedApiCalls": [
    ...
    {
      "name": "deleteRedactedFile",
      "httpMethod": "DELETE",
      "urlTemplate": "/api/v1/access/datafile/{fileId}/auxiliary/qdc/1.0",
      "timeOut": 3600
    },
    {
      "name": "listAuxiliaryFiles",
      "httpMethod": "GET",
      "urlTemplate": "/api/v1/access/datafile/{fileId}/auxiliary",
      "timeOut": 3600
    },
    {
      "name": "getDatasetVersionMetadata",
    ...
    },
    {
      ...
      "httpMethod": "GET",
      "urlTemplate": "/api/v1/datasets/{datasetId}/userPermissions",
      "timeOut": 3600
    }
  ]
}'
